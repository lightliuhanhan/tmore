...
<template>
  <div class="home">
    <div class="content">
      <img src="../assets/one.png" alt="" style="width:100%;height:100%;vertical-align:middle;">
      <img src="../assets/two.png" alt="" style="width:100%;height:100%;vertical-align:middle;">
      <img src="../assets/three.png" alt="" style="width:100%;height:100%;vertical-align:middle;">
      <img src="../assets/four.png" alt="" style="width:100%;height:100%;vertical-align:middle;">
      <!-- 表单输入 -->
      <div class="neibu">
        <div class="neiceng">
        ...
        <van-dialog  v-model = "show" :showConfirmButton="false" width="18.87rem" class="img" :close-on-click-overlay=true>
          <img src="../assets/newlist.png" style="width:18.87rem;height:28.174rem"/>
          <div class="weixin" id="weixini">{{wenxinPhone}}</div>
          <img :src="img" alt="" class="nebImg"/>
          <button type="info" class="bntN"  v-clipboard:success="downlodeImg"  v-clipboard:copy="message"  v-clipboard:error="onError">复制微信号并打开微信</button>
          <div class="opnUp" @click="dispNon">
            <img src="../assets/opnbut.png" alt="" style="width:100%" >
          </div>
        </van-dialog>
      </div>
    </div>
        ...
        upload() {
            ...
            if(!this.phone && !this.yanZhengList && !this.badyName && !this.badyAge){
              ...
              this.$axios({
                ...
                console.log(res.data,"我是res的data")
